    ...
    return (
        <div className="h-full w-full p-4 md:p-8 overflow-auto">
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="mb-8">
                    <h2 className="text-xl md:text-3xl font-bold text-white tracking-tight">Academic Credentials</h2>
                ...
                {edu.map((education, index) => (
                    <motion.div
                        ...
                        className="relative group overflow-hidden rounded-2xl border border-neutral-700/50 bg-neutral-800/40 p-4 md:p-6 hover:bg-neutral-800 transition-colors shadow-lg"
                    >
                        ...
                        <div className="flex flex-col md:flex-row gap-4 md:gap-6 md:items-start">
                            <div className="p-3 md:p-4 bg-neutral-900 rounded-xl border border-neutral-700 shrink-0 w-fit">
                                <GraduationCap size={26} className="text-violet-400 md:hidden" />
                                <GraduationCap size={32} className="text-violet-400 hidden md:block" />
                            </div>

                            <div className="flex-1 space-y-3">
                                <div>
                                    <h3 className="font-bold text-white text-lg md:text-2xl tracking-tight">
                                        {education.title}
                                    </h3>
                                    <p className="text-violet-300 font-medium text-base md:text-lg mt-1">
                                        {education.field}
                                    </p>
                                </div>
